class UserAuthenticationController < ApplicationController
  ...
  def create
    ...
    @user.spotifytopsongs = params.fetch("query_spotifytopsongs")
    @user.spotify_account = params.fetch("query_spotify_account")
...
x      redirect_to("/", { :notice => "User account created successfully."})
    else
